...
print(head(primary_type_counts_1))
```
...
Добијени кластери се могу посматрати као блокови града. У том контексту, приказани су односи кластера, дакле делова града, и доминантне врсте криминала у тим деловима. Из ових приказа могуће је идентификовати делове града који су више, односно мање, опасни, што може бити веома корисно, на пример, приликом планирања безбедносних мера или породичног путовања.
